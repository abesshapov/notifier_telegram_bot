...
__all__ = ["BaseAPIException", "BaseWorkerException"]
...
class BaseWorkerException(Exception):
    ...
    def __init__(self, message: str, details: Optional[Union[str, Exception]] = None):
        """Init BaseWorkerException.

        Args:
            message:
                Message of exception by default is "Worker error".
        """
        if details:
