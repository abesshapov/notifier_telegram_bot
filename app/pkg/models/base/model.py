...
class BaseModel(pydantic.BaseModel):
        ...
        **kwargs,
        ...
        Args:
            ...
            is_json:
                bool.
                default False.
                Specifies whether to convert the values to JSON strings
        ...
        r = {}
        for k, v in values:
            v = self.__cast_values(v=v, is_json=is_json, show_secrets=show_secrets)
            r[k] = v
        return r
    ...
    def __cast_values(
        ...
        **kwargs,
        ...
        elif isinstance(v, Dict) and is_json:
            return json.dumps(v)
